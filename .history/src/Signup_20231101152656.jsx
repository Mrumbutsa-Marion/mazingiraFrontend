    ...
    <div id="sign-up">
      <div className="div">
        <div className="overlap-group">
          ...
          <div id="text-wrapper">Sign Up</div>
          <div className="frame">
          ...
          <div className="i-agree-with-to-the-wrapper">
            <p className="i-agree-with-to-the">
              <span className="span">I agree with to the </span>
              <span className="text-wrapper-5">Terms of User</span>
            </p>
          </div>
          <img className="img" alt="Rectangle" src="/home/user/Pictures/tree" />
...
export default Signup; // Provide a default export
