...
//   const handlePayPalDonationComplete = (data, actions) => {
//     setShowThankYou(true);
//     // Perform any additional processing or updates here
//   };

//   const handleCardPayment = () => {
//     // Handle the separate card payment here
//     // This function will be called when the "Pay With Debit or Credit Card" button is clicked
//   };
...
//                 ],
//                 application_context: {
//                   shipping_preference: 'NO_SHIPPING', // To disable shipping address prompt
//                 },
//               });
//             }}
//             onApprove={(data, actions) => {
//               return actions.order.capture().then((details) => {
//                 handlePayPalDonationComplete(data, actions);
//               });
//             }}
//           />
//           {/* <button onClick={handleCardPayment}>Pay With Debit or Credit Card</button> */}
//         </PayPalScriptProvider>
//         {showThankYou && <p>Thank you for donating to {organizationName}! We appreciate your support.</p>}
//       </div>
//     </div>
//   );
